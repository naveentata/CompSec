...
for i in range(0,len(common_list)):
    ...
    for j in range(0,100):
        # common_list[i] = common_list[i] + str(28)
        new_common_list.append(common_list[i]+ str(j))

print(new_common_list[0])
for i in new_common_list:
    # b = str(i)[1:-1]
    # print(b)
...
formspring_file = open('Password Lists/formspring/formspring.txt')
